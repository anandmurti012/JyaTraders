                    ...
                    <div className="col-lg-5">
                        <div className="">
                            <div className="section-title-two white-title mb-20 tg-heading-subheading animation-style3">
                                ...
                                <h5 style={{ fontSize: '25px' }} className="title tg-element-title">
                                    <strong style={{ color: '#5682e8', fontSize: '20px' }}>Phone:</strong>
                                    <br />
                                    <a href="tel:07856000468" style={{ textDecoration: 'underline', color: 'inherit' }}>
                                        +91 7856000468
                                    </a>
                                </h5>
                                <br />
                                <h5 style={{ fontSize: '25px' }} className="title tg-element-title">
                                    <strong style={{ color: '#5682e8', fontSize: '20px' }}>Email:</strong>
                                    <br />
                                    <a href="mailto:bookings@wheelzcarrentals.com" style={{ textDecoration: 'underline', color: 'inherit' }}>
                                        jyatrades@gmail.com
                                    </a>
                                </h5>
                            </div>
