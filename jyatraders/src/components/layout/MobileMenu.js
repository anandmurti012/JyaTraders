    ...
    return (
        <>
            <ul className="navigation">
                ...
                <li className="menu-item-has-children"><Link href="/about" onClick={handleMobileMenu} >About</Link></li>
                <li className="menu-item-has-children"><Link href="#contact" onClick={handleMobileMenu} >Contacts</Link></li>
            </ul>
        </>
    )
}
